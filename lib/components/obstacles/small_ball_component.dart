...
class SmallBallComponent extends ObstacleComponent {
  SmallBallComponent({required EdgeInsets safeAreaInsets})
      : super(safeAreaInsets: safeAreaInsets, speed: 500, height: 16);
